...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle"><?php _e( 'Menu', 'kool' ); ?></button>
			<a class="assistive-text" href="#content" title="<?php esc_attr_e( 'Skip to content', 'kool' ); ?>"><?php _e( 'Skip to content', 'kool' ); ?></a>
